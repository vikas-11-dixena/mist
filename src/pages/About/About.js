      ...
      <div className="container">
        ...
        <div className="paragraph-about">
          <p>
            ...
            students excel in the tech industry. MIST also organizes initiatives
            like coding challenges, job-oriented programs, and industry-relevant
            workshops to enhance career readiness. For more details about their
            offerings or Surbhi Sharma's contributions, you can contact us at
            1234567890, for more inquiries.
          </p>
        </div>
        ...
        <div className="our-mission">
          ...
          <p className="our-mission-about">
            ...
            affordable education in Full Stack Development (MERN stack), Python
            programming, and practical framework applications. We believe that
            learning should break barriers and foster curiosity beyond
            traditional methods.{" "}
          </p>
          <p className="our-mission-about">
            {" "}
        ...
        <div className="our-services">
          <h2 className="heading-about"> Our Services </h2>
          <div className="services-right">
            <h3 className="sub-heading"> Skill Development Workshops </h3>
            <p className="our-mission-about"> Regular workshops on coding best practices, debugging, and optimization. Industry-focused sessions led by experienced professionals. </p>
          </div>
          <div className="services-right">
            <h3 className="sub-heading"> Project-Based Learning </h3>
            <p className="our-mission-about"> Real-world projects to apply theoretical knowledge. Assistance in building portfolio-worthy projects. Collaborative group projects to simulate industry scenarios. </p>
          </div>
          <div className="services-left">
            <h3 className="sub-heading"> Placement Assistance </h3>
            <p className="our-mission-about"> Resume building and interview preparation. We also providing connections with leading tech companies for internships and job placements. </p>
          </div>
          <div className="services-left">
            <h3 className="sub-heading"> Affordable and Flexible Learning </h3>
            <p className="our-mission-about"> Cost-effective courses accessible to all. Flexible schedules for working professionals and students. </p>
          </div>
        </div>
      </div>
    </div>
